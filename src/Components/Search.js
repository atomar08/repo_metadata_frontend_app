...
class Search extends Component {
    ...
    return (
      <form onSubmit={this.handleSubmit}>
        ...
        <div className='button__container'>
          <center><span><button class='button' onClick={this.search_data}> Search </button> </span></center>
          {
  ...
  search_data = () => {
    if (this.state.repo_name != null && this.state.project_name != null && this.state.commit_id != null) {
      ...
      fetch(process.env.REACT_APP_BACKEND_SERVER + '/git/get_commits_id?repo_name=' + this.state.repo_name +
